...
## Configuration
The only configuration the application supports is via environment variables (that can be specified only via `app.yaml`). If you need to change an environment variable you need to redeploy app.
