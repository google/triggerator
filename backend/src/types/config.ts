 ...
 */
 export var SDF = {
   Campaign: {
     // validated for SDF v5.4
     // See https://developers.google.com/display-video/api/structured-data-file/v5-4/Campaign
     ...
     DemographicTargetingHouseholdIncome:
       "Demographic Targeting Household Income",
     DemographicTargetingParentalStatus:
     ...
     InventorySourceTargeting_TargetNewExchanges:
       "Inventory Source Targeting - Target New Exchanges",
     EnvironmentTargeting: "Environment Targeting",
     // added in 5.4
     CampaignBudgetSegments: "Campaign Budget Segments",
   },
   IO: {
     // validated for SDF v5.4
     // See https://developers.google.com/display-video/api/structured-data-file/v5-4/InsertionOrder
     IoId: "Io Id",
     CampaignId: "Campaign Id",
     Name: "Name",
     Timestamp: "Timestamp",
     ...
     AudienceTargeting_SimilarAudiences:
     ...
     AffinityInMarketTargeting_Include:
       "Affinity & In Market Targeting - Include",
     AffinityInMarketTargeting_Exclude:
     ...
     EnvironmentTargeting: "Environment Targeting",
     ViewabilityTargetingActiveView: "Viewability Targeting Active View",
     ViewabilityTargetingAdPosition_Include:
       "Viewability Targeting Ad Position - Include",
     ViewabilityTargetingAdPosition_Exclude:
     ...
     // added in 5.4:
     ContentDurationTargeting: "Content Duration Targeting", // string, list
     ContentStreamTypeTargeting: "Content Stream Type Targeting",
     IoSubtype: "Io Subtype", // required, 'Default' (if empty), 'Regular Over The Top'
     PerformanceGoalAlgorithmId: "Performance Goal Algorithm Id", // integer, Required when "Performance Goal Type" is "Custom impression value / cost"
     ViewabilityOmidTargetingEnabled: "Viewability Omid Targeting Enabled", // "TRUE", "FALSE"
   },
   LI: {
     // validated for SDF v5.4
     // See https://developers.google.com/display-video/api/structured-data-file/v5-4/LineItem
     ...
     ContentDurationTargeting: "Content Duration Targeting", // string, list
     ContentStreamTypeTargeting: "Content Stream Type Targeting",
     IoName: "Io Name", // string
     ViewabilityOmidTargetingEnabled: "Viewability Omid Targeting Enabled", // "TRUE", "FALSE"
   },
   AdGroup: {
     // validated for SDF v5.3
     // See https://developers.google.com/display-video/api/structured-data-file/v5-4/AdGroup
     ...
     CategoryTargeting_Include: "Category Targeting - Include",
     CategoryTargeting_Exclude: "Category Targeting - Exclude",
     PlacementTargeting_YouTubeChannels_Include:
       "Placement Targeting - YouTube Channels - Include",
     PlacementTargeting_YouTubeChannels_Exclude:
       "Placement Targeting - YouTube Channels - Exclude",
     PlacementTargeting_YouTubeVideos_Include:
       "Placement Targeting - YouTube Videos - Include",
     PlacementTargeting_YouTubeVideos_Exclude:
       "Placement Targeting - YouTube Videos - Exclude",
     PlacementTargeting_PopularContent_Include:
     ...
     PlacementTargeting_AppCollections_Include:
       "Placement Targeting - App Collections - Include",
     PlacementTargeting_AppCollections_Exclude:
     ...
     CustomListTargeting: "Custom List Targeting",
     // added in 5.4:
     LineItemName: "Line Item Name", // string
   },
   Ad: {
     // validated for SDF v5.4
     // https://developers.google.com/display-video/api/structured-data-file/v5-4/AdGroupAd
     AdId: "Ad Id",
     AdGroupId: "Ad Group Id",
     Name: "Name",
     Status: "Status",
...
export const SDF_VERSION = '5.4'; // the latest supported SDF Version (see https://developers.google.com/display-video/api/structured-data-file/rel-notes?hl=en)